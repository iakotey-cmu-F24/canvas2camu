...
pub(crate) fn parse_args() -> ArgStruct {
...

    {
        ...
        parser
            ...
            .add_argument("enrollment", Store, "Path to enrollment data from CAMU")
            .required();
        ...
        parser.refer(&mut args.as_zip).add_option(&["-z", "--zip"], StoreTrue, "Save as zip");
...

    {
        ...
        if !args.output_dir.is_dir() {
            ...
            args.output_dir =
                home_dir().expect("Output directory could not be found: Try using -o option");
        };
    }
